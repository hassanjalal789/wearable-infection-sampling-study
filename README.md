...
12. [Reproducibility guide](docs/REPRODUCIBILITY.md) and [verification report](docs/VERIFICATION_REPORT.md) — what can be re-run from this repository, how, and what the checks for this publication showed.
...
Not yet published: citation metadata. Every research artifact group now has a published location or a stated reason for exclusion; the [manifest](evidence/PUBLICATION_MANIFEST.csv) lists each one.
