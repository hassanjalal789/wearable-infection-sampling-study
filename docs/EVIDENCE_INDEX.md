...
- The result tables, digest and figures were regenerated from the published summary files; no aggregate has been recomputed from the source data, and the BCa intervals were not recomputed.
